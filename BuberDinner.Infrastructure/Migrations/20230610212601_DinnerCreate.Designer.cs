...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20230610212601_DinnerCreate")]
            ...
            modelBuilder.Entity("BuberDinner.Domain.GuestAggregate.Guest", b =>
                {
                    ...
                    b.OwnsMany("BuberDinner.Domain.GuestAggregate.Entities.GuestRating", "GuestRatings", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("BuberDinner.Domain.DinnerAggregate.ValueObjects.DinnerId", "DinnerIds", b1 =>
                        {
                            ...
                            b1.ToTable("GuestDinnerIds", (string)null);
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuAggregate.Entities.MenuSection", "Sections", b1 =>
                        {
                            ...
                            b1.ToTable("MenuSetions", (string)null);

...
public static partial class Constants
{
    public static class Menu
    {
        ...
        public static string SectionDescriptionFromIndex(int index) => $"{SectionName} {index}";
        public static string ItemNameFromIndex(int index) => $"{SectionName} {index}";
        public static string ItemDescriptionFromIndex(int index) => $"{SectionName} {index}";
    }
}
